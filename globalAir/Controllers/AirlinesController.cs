...
namespace globalAir.Controllers
{
    public class AirlinesController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Airlineid,AirlineName")] Airline airline)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Airlineid,AirlineName")] Airline airline)
        {
            if (ModelState.IsValid)
            {
